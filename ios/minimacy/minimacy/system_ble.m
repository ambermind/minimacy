...
- (int) send:(NSData*)data {
    ...
    [blePeripheral writeValue:data forCharacteristic:bleTxChar type:CBCharacteristicWriteWithResponse];
...
int fun_bleSerialName(Thread* th)
{
    ...
    FUN_RETURN_STR([name cStringUsingEncoding:NSISOLatin1StringEncoding], -1);
}
