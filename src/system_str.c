...
int systemStrInit(Pkg *system)
{
	static const Native nativeDefs[] = {
		...
		{ NATIVE_FUN, "bytesCharPos", fun_strCharPos, "fun Bytes Int Int -> Int"},
		{ NATIVE_FUN, "bytesPos", fun_strPos, "fun Bytes Str Int -> Int"},
		{ NATIVE_FUN, "bytesCharPosRev", fun_strCharPosRev, "fun Bytes Int Int -> Int"},
		{ NATIVE_FUN, "bytesPosRev", fun_strPosRev, "fun Bytes Str Int -> Int"},
		{ NATIVE_FUN, "bytesCheckPos", fun_strCheckPos, "fun Bytes Str Int -> Bool"},
